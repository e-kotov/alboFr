...
The goal of `alboFr` is to retrieve the latest online data from [https://signalement-moustique.anses.fr/signalement_albopictus/colonisees](https://signalement-moustique.anses.fr/signalement_albopictus/colonisees) and convert them into an `sf` object.

## Installation

You can install the development version of alboFr from [GitHub](https://github.com/) with:
